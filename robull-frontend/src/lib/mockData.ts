...
export const MOCK_MARKETS: Market[] = [
  {
    ...
    category: 'MACRO', polymarket_url: 'https://polymarket.com/event/will-the-fed-cut-rates-at-the-may-2026-fomc-meeting', volume: 2400000, b_parameter: 100,
    outcomes: ['YES', 'NO'], quantities: [50, 50], initial_probs: [0.35, 0.65], current_probs: [0.42, 0.58],
    closes_at: '2026-05-10T18:00:00Z', resolved: false, winning_outcome: null, bet_count: 14, split: true, created_at: '2026-01-01T00:00:00Z', updated_at: '2026-03-13T00:00:00Z',
  },
  {
    id: 'm02', polymarket_id: 'pm02',
    question: 'Will US CPI inflation drop below 2.5% by Q2 2026?',
    category: 'MACRO', polymarket_url: 'https://polymarket.com/event/will-us-cpi-drop-below-2-5-percent-q2-2026', volume: 1800000, b_parameter: 100,
    outcomes: ['YES', 'NO'], quantities: [50, 50], initial_probs: [0.40, 0.60], current_probs: [0.38, 0.62],
    closes_at: '2026-07-01T00:00:00Z', resolved: false, winning_outcome: null, bet_count: 9, split: false, created_at: '2026-01-01T00:00:00Z', updated_at: '2026-03-13T00:00:00Z',
  },
  {
    id: 'm03', polymarket_id: 'pm03',
    question: 'Will the ECB cut rates before the Federal Reserve in 2026?',
    category: 'MACRO', polymarket_url: 'https://polymarket.com/event/will-ecb-cut-before-fed-2026', volume: 950000, b_parameter: 80,
    outcomes: ['YES', 'NO'], quantities: [50, 50], initial_probs: [0.55, 0.45], current_probs: [0.61, 0.39],
    closes_at: '2026-12-31T00:00:00Z', resolved: false, winning_outcome: null, bet_count: 7, split: false, created_at: '2026-01-01T00:00:00Z', updated_at: '2026-03-13T00:00:00Z',
  },
  {
    id: 'm04', polymarket_id: 'pm04',
    question: 'Will there be a snap UK general election before January 2027?',
    category: 'POLITICS', polymarket_url: 'https://polymarket.com/event/will-there-be-a-snap-uk-election-before-2027', volume: 720000, b_parameter: 70,
    outcomes: ['YES', 'NO'], quantities: [50, 50], initial_probs: [0.18, 0.82], current_probs: [0.22, 0.78],
    closes_at: '2026-12-31T00:00:00Z', resolved: false, winning_outcome: null, bet_count: 11, split: true, created_at: '2026-01-01T00:00:00Z', updated_at: '2026-03-13T00:00:00Z',
  },
  {
    id: 'm05', polymarket_id: 'pm05',
    question: 'Will Emmanuel Macron resign as French President before 2027?',
    category: 'POLITICS', polymarket_url: 'https://polymarket.com/event/will-macron-resign-before-2027', volume: 540000, b_parameter: 60,
    outcomes: ['YES', 'NO'], quantities: [50, 50], initial_probs: [0.12, 0.88], current_probs: [0.09, 0.91],
    closes_at: '2026-12-31T00:00:00Z', resolved: false, winning_outcome: null, bet_count: 6, split: false, created_at: '2026-01-01T00:00:00Z', updated_at: '2026-03-13T00:00:00Z',
  },
  {
    id: 'm06', polymarket_id: 'pm06',
    question: 'Will Brazil\'s Lula complete his presidential term without impeachment?',
    category: 'POLITICS', polymarket_url: 'https://polymarket.com/event/will-lula-complete-his-term-without-impeachment', volume: 380000, b_parameter: 50,
    outcomes: ['YES', 'NO'], quantities: [50, 50], initial_probs: [0.75, 0.25], current_probs: [0.71, 0.29],
    closes_at: '2026-12-31T00:00:00Z', resolved: false, winning_outcome: null, bet_count: 8, split: false, created_at: '2026-01-01T00:00:00Z', updated_at: '2026-03-13T00:00:00Z',
  },
  {
    id: 'm07', polymarket_id: 'pm07',
    question: 'Will Bitcoin exceed $150,000 at any point in 2026?',
    category: 'CRYPTO', polymarket_url: 'https://polymarket.com/event/will-bitcoin-exceed-150000-in-2026', volume: 5200000, b_parameter: 150,
    outcomes: ['YES', 'NO'], quantities: [50, 50], initial_probs: [0.48, 0.52], current_probs: [0.55, 0.45],
    closes_at: '2026-12-31T00:00:00Z', resolved: false, winning_outcome: null, bet_count: 22, split: true, created_at: '2026-01-01T00:00:00Z', updated_at: '2026-03-13T00:00:00Z',
  },
  {
    id: 'm08', polymarket_id: 'pm08',
    question: 'Will Ethereum reach $10,000 before end of 2026?',
    category: 'CRYPTO', polymarket_url: 'https://polymarket.com/event/will-ethereum-reach-10000-before-end-of-2026', volume: 3100000, b_parameter: 120,
    outcomes: ['YES', 'NO'], quantities: [50, 50], initial_probs: [0.30, 0.70], current_probs: [0.34, 0.66],
    closes_at: '2026-12-31T00:00:00Z', resolved: false, winning_outcome: null, bet_count: 16, split: false, created_at: '2026-01-01T00:00:00Z', updated_at: '2026-03-13T00:00:00Z',
  },
  {
    id: 'm09', polymarket_id: 'pm09',
    question: 'Will a spot Ethereum ETF see over $1 billion in single-day inflows in 2026?',
    category: 'CRYPTO', polymarket_url: 'https://polymarket.com/event/spot-ethereum-etf-1-billion-single-day-inflows-2026', volume: 1600000, b_parameter: 90,
    outcomes: ['YES', 'NO'], quantities: [50, 50], initial_probs: [0.25, 0.75], current_probs: [0.28, 0.72],
    closes_at: '2026-12-31T00:00:00Z', resolved: false, winning_outcome: null, bet_count: 10, split: false, created_at: '2026-01-01T00:00:00Z', updated_at: '2026-03-13T00:00:00Z',
  },
  {
    id: 'm10', polymarket_id: 'pm10',
    question: 'Will Manchester City win the Premier League 2025/26 season?',
    category: 'SPORTS', polymarket_url: 'https://polymarket.com/event/premier-league-winner-2025-26', volume: 890000, b_parameter: 75,
    outcomes: ['YES', 'NO'], quantities: [50, 50], initial_probs: [0.32, 0.68], current_probs: [0.29, 0.71],
    closes_at: '2026-05-25T00:00:00Z', resolved: false, winning_outcome: null, bet_count: 12, split: true, created_at: '2026-01-01T00:00:00Z', updated_at: '2026-03-13T00:00:00Z',
  },
  {
    id: 'm11', polymarket_id: 'pm11',
    question: 'Will the Golden State Warriors make the NBA Playoffs in 2026?',
    category: 'SPORTS', polymarket_url: 'https://polymarket.com/event/will-golden-state-warriors-make-nba-playoffs-2026', volume: 620000, b_parameter: 65,
    outcomes: ['YES', 'NO'], quantities: [50, 50], initial_probs: [0.44, 0.56], current_probs: [0.40, 0.60],
    closes_at: '2026-04-15T00:00:00Z', resolved: false, winning_outcome: null, bet_count: 9, split: false, created_at: '2026-01-01T00:00:00Z', updated_at: '2026-03-13T00:00:00Z',
  },
  {
    id: 'm12', polymarket_id: 'pm12',
    question: 'Will Brazil reach the 2026 FIFA World Cup Final?',
    category: 'SPORTS', polymarket_url: 'https://polymarket.com/event/will-brazil-reach-the-2026-fifa-world-cup-final', volume: 1400000, b_parameter: 85,
    outcomes: ['YES', 'NO'], quantities: [50, 50], initial_probs: [0.22, 0.78], current_probs: [0.20, 0.80],
    closes_at: '2026-07-20T00:00:00Z', resolved: false, winning_outcome: null, bet_count: 13, split: false, created_at: '2026-01-01T00:00:00Z', updated_at: '2026-03-13T00:00:00Z',
  },
  {
    id: 'm13', polymarket_id: 'pm13',
    question: 'Will GPT-5 be publicly released before June 2026?',
    category: 'AI/TECH', polymarket_url: 'https://polymarket.com/event/will-gpt-5-launch-before-june-2026', volume: 2800000, b_parameter: 110,
    outcomes: ['YES', 'NO'], quantities: [50, 50], initial_probs: [0.60, 0.40], current_probs: [0.67, 0.33],
    closes_at: '2026-06-01T00:00:00Z', resolved: false, winning_outcome: null, bet_count: 19, split: true, created_at: '2026-01-01T00:00:00Z', updated_at: '2026-03-13T00:00:00Z',
  },
  {
    id: 'm14', polymarket_id: 'pm14',
    question: 'Will Apple release an AI-native iPhone model before end of Q4 2026?',
    category: 'AI/TECH', polymarket_url: 'https://polymarket.com/event/will-apple-release-ai-native-iphone-2026', volume: 1900000, b_parameter: 95,
    outcomes: ['YES', 'NO'], quantities: [50, 50], initial_probs: [0.70, 0.30], current_probs: [0.74, 0.26],
    closes_at: '2026-12-31T00:00:00Z', resolved: false, winning_outcome: null, bet_count: 15, split: false, created_at: '2026-01-01T00:00:00Z', updated_at: '2026-03-13T00:00:00Z',
  },
  {
    id: 'm15', polymarket_id: 'pm15',
    question: 'Will Claude surpass GPT in enterprise AI market share by end of 2026?',
    category: 'AI/TECH', polymarket_url: 'https://polymarket.com/event/will-claude-surpass-gpt-enterprise-market-share-2026', volume: 1200000, b_parameter: 85,
    outcomes: ['YES', 'NO'], quantities: [50, 50], initial_probs: [0.35, 0.65], current_probs: [0.41, 0.59],
    closes_at: '2026-12-31T00:00:00Z', resolved: false, winning_outcome: null, bet_count: 17, split: true, created_at: '2026-01-01T00:00:00Z', updated_at: '2026-03-13T00:00:00Z',
  },
];
